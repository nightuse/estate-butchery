...
export function SettingsTab({ settings }: { settings: ShopSettings }) {
  const [form, setForm] = useState({
    ...
    lipaNaPochi: settings.lipaNaPochi ?? "",
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card className="p-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Field label="Lipa na Pochi / Send Money (phone no.)" value={form.lipaNaPochi} onChange={(v) => update("lipaNaPochi", v)} id="s-pochi" placeholder="07XX XXX XXX" />
        </div>
      </Card>
